...
const CustomTabBar = (props) => {
  return (
    <TabBar
      {...props}
      indicatorStyle={{ backgroundColor: '#eeaeca' }} // Set the indicator color
      style={{ backgroundColor: '#fff' }} // Set the background color of the tab bar
      labelStyle={{ color: 'black', fontSize: responsiveFontSize(1.8) }} // Set the label text color
    />
  );
};
